"""
Django settings for Razid project.
...
SECRET_KEY = 'django-insecure-k+_v69ax9ii=qgv&l_&*bb@jf!)a)d*8o(2$f8nd*3e$r3!s2_'
...
STATIC_URL = '/static/'  # Make sure it ends with a trailing slash
STATICFILES_DIRS = [
    BASE_DIR / "static",
    "/var/www/static/",
]
...
#     'SERIALIZERS': {
#         'user_create' : 'apiapp.serializers.UserCreateSerializer',
#         'user' : 'apiapp.serializers.UserCreateSerializer',
...
# Increase the maximum allowed size for request data
DATA_UPLOAD_MAX_MEMORY_SIZE = 20 * 1024 * 1024  # 20 MB

# Increase the maximum allowed size for individual file uploads
